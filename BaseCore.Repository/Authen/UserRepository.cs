...
namespace BaseCore.Repository.Authen
{
    ...
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(BaseCoreSalesContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Users.FirstOrDefaultAsync(u => u.Id == int.Parse(id));
        }
        ...
        {
            var user = await _context.Users.FirstOrDefaultAsync(u => u.Id == int.Parse(id));
            if (user == null)
            {
                return;
            }
